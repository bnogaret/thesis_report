...
Another import feature of the food is the tetxure. Numerous texture feature can be used such as Gabor filters. As already presented, the local binary pattern is also applyed.
